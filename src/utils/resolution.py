...
def setup_ui(main_app):
    ...
    main_app.simpcity_dl_images_cb.setChecked(True)
    ...
    simpcity_cookie_layout.setContentsMargins(0, 5, 0, 0)
    ...
    simpcity_cookie_layout.addWidget(main_app.simpcity_cookie_text_input, 1)
